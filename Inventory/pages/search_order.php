      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content" style="min-height: 560px;">
            <center><b><h3 style="margin-top: -10px;">Search Order</h3></center></b>
            <div class="col-md-12">
				  ...
				  <form method="post" action="">
					<div class="form-group col-md-3">
						<div class="input-group">
						  <input type="text" name="order_id" class="form-control pull-right active" required>
					   </div>
                <!-- /.input group -->
					</div>
...
<?php
	$query=mysqli_query($con,"select * from create_order where order_id='$order_id'")or die(mysqli_error($con));
...
?>
        <tr>
            ...
            <td><a href="productOrderView.php?order_id=<?php echo $row['order_id'];?>&m_id=<?php echo $row['m_id']; ?>">View</a></td>   
 <?php } ?>                       
        </tr>
    </tbody>
    </table>
