...
echo "<script>document.location='../index.php'</script>";
    ...
    if(!isset($_GET['deli_id'])){
        echo "<script>location.href = 'memberwise_delivery_search.php';</script>";
    }else{
  ...
  <body class="hold-transition layout-top-nav">
      ...
      <div class="content-wrapper" style="min-height: 560px">
        <div class="container">
          ...
          <section class="content-header">
            <h1>
              <a class="btn btn-lg btn-warning" href="memberwise_delivery.php">Back</a>
            </h1>
            <ol class="breadcrumb">
    ...
    ?>
                  <tr>
                    ...
                    <td><?php 
                    $prod_id = $row['prod_id'];
                    $qry=mysqli_query($con,"select prod_name from product where  
                            prod_id='$prod_id'");
