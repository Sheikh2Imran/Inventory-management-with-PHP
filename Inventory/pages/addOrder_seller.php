  ...
  <body class="hold-transition skin-<?php echo $_SESSION['skin'];?> layout-top-nav">
      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header" style="text-transform: uppercase;font-weight: bold;line-height: 20px;">
            <h1></h1>
            <center><b><h4>Order List To Buy from <?php echo $m_company."(".$m_name.")"; ?></h4></center></b>
            <ol class="breadcrumb">
              <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
              <li class="active">Buy From Supplier</li>
            </ol>
          </section>
    ...
    ?>
            <tr> 
                ...
                <?php echo "|"; } ?>
                <a onclick="return confirm('Are you sure to delete this order ?');" href="delete_order_seller.php?order_id=<?php echo $order_id;?>&m_id=<?php echo $m_id;?>">X</a> 
                </td>
            </tr>
    <?php } ?>
                    </tbody>
