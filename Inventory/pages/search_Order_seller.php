      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header" style="text-transform: uppercase;font-weight: bold;line-height: 20px;">
            <center><b><h3 style="margin-top: -5px;">Order To Buy</h3></b></center>         
            <ol class="breadcrumb">
          ...
          <div class="col-md-6">
            ...
            <?php
                ...
                if (isset($_POST['submit1'])) {
                    ...
                    echo "<script>document.location='order_add.php?m_id=$m_id'</script>";
                }
            ?>
            ...
            <?php
                $query1=mysqli_query($con,"select * from member where m_status='supplier'");
