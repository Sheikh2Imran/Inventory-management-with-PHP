      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header" style="text-transform: uppercase;font-weight: bold;line-height: 20px;">
            ...
            <center><b><h3 style="margin-top: -40px;">Customer List</h3></center></b>
            <ol class="breadcrumb">
          ...
          <div class="col-md-6">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Select any Customer from here</h3>
                </div>
                <div class="box-body">
            <?php
            ...
            <?php
                $query1=mysqli_query($con,"select DISTINCT m_id, company, Mobile from order_view where status='sell' order by m_id desc");
