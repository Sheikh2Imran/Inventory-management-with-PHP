...
<html>
  ...
  <body class="hold-transition skin-<?php echo $_SESSION['skin'];?> layout-top-nav">
        ...
        <div class="container">
          ...
          <section class="content-header" style="text-transform: uppercase;font-weight: bold;line-height: 20px;">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Customer ledger view</li>
            </ol>
          </section>
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Customer Ledger List</h3>
                </div>
                <div class="box-body">
                  <table id="" class="table table-bordered table-striped">
                    ...
                    <tbody>
    <?php
        $query=mysqli_query($con,"select * from customer_ledger_view_display where m_id='$m_id'");
    ...
    <?php
        $query=mysqli_query($con,"select * from sum_customer_ledger_view where m_id='$m_id'");
           $row=mysqli_fetch_array($query);
    ?>
            <tr>
                <td></td>
    ...
    <?php 
        ...
        echo "<script>document.location='ledger_customer.php?m_id=$m_id'</script>";
        }
    ?>
