...
?>
                      <tr>
                        ...
                        <td><?php echo $row['supplier_dor'];?></td>
	  ...
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
              ...
              <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="status" placeholder="Contact # of Supplier" value="<?php echo $row['supplier_status'];?>" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->  
              <div class="form-group">
                <label for="date">DOR</label>
                <div class="input-group col-md-12">
                  <input type="text" class="form-control pull-right" id="date" name="dor" placeholder="Contact # of Supplier" value="<?php echo $row['supplier_dor'];?>" required>
                </div><!-- /.input group -->
              </div><!-- /.form group -->  
...
<?php }?>					  
	  ...
	  <div class="col-md-3">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add New Mamber</h3>
                </div>
                <div class="box-body">
                  <!-- Date range -->
              ...
              <div class="form-group">
                    <label for="date">DOR</label>
                    <div class="input-group col-md-12">
                      <input type="date" class="form-control pull-right" id="date" name="dor" value="<?php echo date('Y-m-d');?>" required>
                    </div><!-- /.input group -->
              </div><!-- /.form group -->  
