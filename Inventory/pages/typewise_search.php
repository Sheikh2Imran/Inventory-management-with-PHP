				...
				<div class="box-body">
				  ...
				  <form method="POST" action="">
					<div class="form-group col-md-3">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="mem_status">
                            <option value="supplier">Supplier</option>
                            <option value="customer">Customer</option>
                            <option value="owner">Owner</option>
                        </select>
                    </div><br>
					<button style="margin-top: 4px;" type="submit" class="btn btn-primary" name="display">Display</button>
				</form>
...
<?php
	$query=mysqli_query($con,"select * from member where mem_status='$mem_status'")or die(mysqli_error($con));
        $i=0;
...
?>
        <tr>
            ...
            $query1=mysqli_query($con,"select trans_id from member_status_view where member_status='$mem_status' and name='$mem_name'")or die(mysqli_error($con));
            ...
            <td><?php 
            $trans_id = $row1['trans_id'];
            if ($mem_status == "customer") { ?>
                <a href="addOrder_buyer.php?trans_id=<?php echo $trans_id;?>">View</a>
            <?php }else { ?>
            <a href="addOrder_buyer.php?trans_id=<?php echo $row1['trans_id'];?>">View</a>
            <?php } ?>
            </td>  
 <?php } ?>                       
        </tr>
