      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header" style="text-transform: uppercase;font-weight: bold;line-height: 20px;">
            <center><b><h3 style="margin-top: -5px;">Sell To Member</h3></center></b>
            <ol class="breadcrumb">
              <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
              <li class="active">Sell to member</li>
            </ol>
          </section>
          <!-- Main content -->
	      ...
	      <div class="col-md-6">
            ...
            <?php
                ...
                if (isset($_POST['submit1'])) {
                    $m_id = $_POST['m_id'];
                    echo "<script>document.location='delivery_to_member_sell.php?m_id=$m_id'</script>";
                }
            ?>
            ...
            <?php
    		    $query1=mysqli_query($con,"select * from member where m_status='customer'");
