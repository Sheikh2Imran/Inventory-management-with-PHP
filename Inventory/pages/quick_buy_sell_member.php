  ...
  <body class="hold-transition-skin layout-top-nav">
          ...
          <section class="content">
            ...
            ?>
                  <tr>
                    ...
                    ||
                    <a onclick="return confirm('Are you sure to delete this product?');" href="quick_product_delete.php?deli_id=<?php echo $deli_id;?>&m_id=<?php echo $m_id;?>&status=<?php echo $status;?>&dd_id=<?php echo $row1['dd_id'];?>"><i class="glyphicon glyphicon-remove text-red"></i></a>
                    </td>
                  </tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="height:auto">
            ...
            <form class="form-horizontal" method="POST" action="quick_product_update.php?deli_id=<?php echo $deli_id;?>&m_id=<?php echo $m_id;?>&status=<?php echo $status;?>">
...
<?php
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        mysqli_query($con,"CALL insert_deli_det('$prod_id','$dd_qty','$deli_id',@msg)")or die(mysqli_error($con));
...
?>
      ...
      <div class="col-md-3">
            ...
            <?php
                $query2=mysqli_query($con,"select * from product")or die(mysqli_error());
...
<?php 
    if (isset($_POST['submit4'])) {
        ...
        echo "<script>location.href = 'quick_buy_sell_member.php?deli_id=$order_id&m_id=$m_id&status=$status';</script>";
     }
?>
             <div class="box box-primary">
                <div class="box-header">
                ...
                <div class="box-body">
        <?php
            $qry1=mysqli_query($con,"select * from create_delivery where deli_id='$deli_id' and m_id='$m_id'");
        ...
        ?>
            ...
            <?php
                $qry=mysqli_query($con,"select paid_amount from create_delivery where deli_id='$deli_id' and m_id='$m_id'")or die(mysqli_error());
            ...
            ?> 
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <!-- Date range -->
            <form method="POST" action="paid_amount.php?deli_id=<?php echo $deli_id;?>&m_id=<?php echo $m_id;?>&status=<?php echo $status;?>">
                <div class="form-group">
