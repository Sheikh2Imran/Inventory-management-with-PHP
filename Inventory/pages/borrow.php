...
if (isset($_POST['submit'])) {
   ...
   mysqli_query($con,"CALL borrow_product('$prod_id','$deli_id','$prod_qty','$r_date',@msg)");
        ...
        <div class="container">
          ...
          <section class="content-header" style="text-transform: uppercase;font-weight: bold;line-height: 20px;">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Borrow Product</li>
            </ol>
          </section>
          <!-- Main content -->
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Total Borrow List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                		$query=mysqli_query($con,"select * from borrow_view");
                    ...
                    ?>
                      <tr>
                        ...
                        ||
                        <a onclick="return confirm('Are you sure to remove this borrow ?');" href="borrow_delete.php?deli_id=<?php echo $row['deli_id'];?>&prod_id=<?php echo $row['prod_id'];?>">Remove</a>
						</td>
                      </tr>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Update Borrow Details</h4>
              </div>
              <div class="modal-body">
			  <form class="form-horizontal" method="POST" action="borrow_update.php">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group col-md-12"><input type="hidden" class="form-control" id="id" name="r_date" value="<?php echo $row['r_date'];?>">  
                    <input type="date" class="form-control" id="name" name="r_date" value="<?php echo $row['r_date'];?>">  
                  </div>
                </div>  
              </div><hr>
...
<?php } ?>					  
            ...
            <div class="col-md-3">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add New Borrow</h3>
                </div>
                <div class="box-body">
        ...
        ?>
          <form method="POST" action=""> 
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="date" class="form-control pull-right" id="date" name="r_date">
                    </div><!-- /.input group -->
                </div><!-- /.form group -->
                  <div class="form-group">
                    <div class="input-group">
